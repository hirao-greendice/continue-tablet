      ...
      <div className="scene-one-content">
        ...
        <div className="scene-one-text-panel">
          <p>
            ...
            <br />
            ボクが<strong>記憶を消した</strong>だけなので、
            <br />
            安心してボクの話を聞いてほしい。
          </p>
          <p>ボクは<strong>天使</strong>。
           <br />
            運命が狂ってしまった人間を助ける使者だよ。</p>
          <p>
            君たちが遊んでいる<br />「幻の秘宝『コバルト・ハート』の消失」<br />というナゾトキイベントでは、<br />いつもとは違う大変なことが起こっているんだ。
            <br />
          ...
          <p>
            文字で説明するより聞かせたほうがいいか。
            <br />
            みんなが<strong>この会場に入る前</strong>に私がみた光景を、
            <br />
  ...
  return (
    <>
      <div className="scene-two-content">
        ...
        <p>
          とにかく今ここには<strong>強盗</strong>がいて、
          <br />
          スタッフの必死の努力も虚しく、
          <br />
          ゲームが終わったあとの解説で、
          ...
          「おかしなこと」に気づいた強盗によって、
          <br />
          君たちは<strong>死ぬ運命</strong>にあるんだ。
        </p>
        <p>
          誰が強盗なのか詳しく教えてあげたいんだけど、
          <br />
          天使の掟で<strong>「人の運命を直接変える」</strong>ことは
          <br />
          <span className="scene-two-emphasis">禁止</span>されているんだよね。
        </p>
        <p>
          ただ、安心して。
          <br />
        ...
        <p>
          さっき神様と交渉して、君たちが助かる方法を
          <br />
          見つけてきたよ。それは、
          <br />
          <span className="scene-two-insight">君たちのひらめきで強盗を突き止める</span>
          <br />
          ことができたら、
          <br />
          ボクが強盗に<strong>「改心の一撃」</strong>を放つこと！
        </p>
        <p>
          実は、この会場で羽を付けて君たちを
          <br />
          見守っていたのは、<strong>ボクの仲間</strong>なんだ。
          <br />
        ...
        <p>
          ...
          という注意事項を思い出して、
          <br />
          「退席すれば死の運命を回避できるじゃん！」って
          <br />
          思った人、いるでしょ？
          <br />
          残念ながら<strong>そんな方法では回避はできない</strong>よ。
          <br />
          チームメイトと仲良く協力して、
          <br />
          エレガントに死の運命を回避してね。
