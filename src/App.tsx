    ...
    <section className="story-screen scene-one">
      ...
      <div className="scene-one-content">
        ...
        <div className="scene-one-text-panel">
          ...
          <p>
            君たちが遊んでいる<br />「幻の秘宝コバルト・ハートの消失」<br />というナゾトキイベントでは、<br />いつもとは違う、大変なことが起こっているんだ。
          </p>
          <p>
            文字で説明するより聞かせたほうがいいか。
            <br />
            君たちが<strong>この会場に入る前</strong>にボクがみた光景を、
            <br />
  ...
  return (
    <>
      <div className="scene-two-content">
        ...
        <div className="scene-two-text-block">
          <p>
            とにかく今ここには<strong>泥棒</strong>が入っていて、
            <br />
            スタッフの必死の努力も虚しく、
            <br />
            ゲームが終わったあとの解説で、
        ...
        <div className="scene-two-text-block">
          ...
          <p>
            ...
            ことができたら、
            <br />
            ボクが泥棒に<strong>「改心の一撃」</strong>を放つこと！
          </p>
        </div>
        <div className="scene-two-text-block">
          <p>
